...
export const ui = {
  ...
  de: {
    ...
    'nalua.faq_6_a': "Klassische Gesundheits-Apps setzen oft auf Gamification, um Nutzer in der App zu halten. Wir glauben: Wer akut überreizt ist oder sein Nervensystem regulieren möchte, braucht keinen zusätzlichen Druck durch „300-Tage-Streaks“ oder Benachrichtigungen. <em>nalua</em> ist ein digitaler Rückzugsort. Es gibt keine Ziele zu erreichen – du öffnest die App, atmest durch und schließt sie wieder, völlig ohne schlechtes Gewissen.",
